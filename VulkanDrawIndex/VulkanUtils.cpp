...
static VKAPI_ATTR VkBool32 VKAPI_CALL debugCallback(VkDebugReportFlagsEXT flags, VkDebugReportObjectTypeEXT objType, uint64_t obj, size_t location, int32_t code, const char* layerPrefix, const char* msg, void* userData) {
    std::cerr << "这个是错误~~~validation layer: " << msg << std::endl;
...
*/
VkDebugReportCallbackEXT VulkanUtils::SetupDebugCallback(VkInstance instance) {
...
*/
void VulkanUtils::DestroyDebugReportCallbackEXT(VkInstance instance, VkDebugReportCallbackEXT callback, const VkAllocationCallbacks* pAllocator) {
...
* @return 窗口surface
*/
VkSurfaceKHR VulkanUtils::CreateSurface(VkInstance instance, GLFWwindow *window) {
...
* @return 物理设备
*/
VkPhysicalDevice VulkanUtils:: PickPhysicalDevice(VkInstance instance, VkSurfaceKHR surface) {
...
*/
VkDevice VulkanUtils::CreateLogicalDevice(VkPhysicalDevice physicalDevice, VkSurfaceKHR surface, VkQueue *graphicsQueue, VkQueue *presentQueue) {
    VkDevice device;
...
*/
VkSwapchainKHR VulkanUtils::CreateSwapChain(VkPhysicalDevice physicalDevice, VkSurfaceKHR surface, GLFWwindow *window, VkDevice device, std::vector<VkImage> *swapChainImages,
...
std::vector<VkImageView> VulkanUtils::CreateImageViews(std::vector<VkImage> swapChainImages, VkFormat swapChainImageFormat, VkDevice device) {
...
VkRenderPass VulkanUtils::CreateRenderPass(VkFormat swapChainImageFormat, VkDevice device) {
...
std::vector<VkFramebuffer> VulkanUtils::CreateFramebuffers(std::vector<VkImageView> swapChainImageViews, VkRenderPass renderPass, VkExtent2D swapChainExtent, VkDevice device) {
...
VkCommandPool VulkanUtils::CreateCommandPool(VkPhysicalDevice physicalDevice, VkSurfaceKHR surface, VkDevice device) {
